...
<head>
    ...
    <link rel="stylesheet" type="text/css" media='all'
          href="<?php echo site_url($this->config->item('template_url') . '/' . $this->config->item('template')) ?>/style.css?v=1.4.2"/>
    <?php if ($this->config->item('is_rtl')) : ?>
    <link rel="stylesheet" type="text/css" media='all'
          href="<?php echo site_url($this->config->item('template_url') . '/' . $this->config->item('template')) ?>/style_rtl.css?v=1.4.2"/>
    <?php endif ?>
    <?php if (isset($_GET['pda'])): ?>
    <meta name="viewport" id="viewport" content="width=device-width"/>
    <link rel="stylesheet" type="text/css" media='all'
          href="<?php echo site_url($this->config->item('template_url') . '/' . $this->config->item('template')) ?>/pda.css?v=1.4.2"/>
    <?php else: ?>
    <link rel="stylesheet" type="text/css" media='print'
          href="<?php echo site_url($this->config->item('template_url') . '/' . $this->config->item('template')) ?>/print.css?v=1.4.2"/>
    <?php endif ?>
...
<body>
            ...
            <div id="mtt_body">
                ...
                <div id="bar">
                    ...
                    <div class="bar-menu">
                        ...
                        <span id="bar_auth">
                            ...
                            <a href="#login" id="bar_login" class="nodecor"><u><?php echo lang('a_login') ?></u> <span
                                class="arrdown"></span></a>
                ...
                <div id="page_tasks" style="display:none">
                    ...
                    <div id="lists">
                        ...
                        <div id="tabs_buttons">
                            <div class="mtt-tabs-select-button mtt-tabs-button" title="<?php echo lang('list_select') ?>">
                                <span></span>
                            </div>
                        </div>
                        <div id="list_all" class="mtt-tab mtt-tabs-alltasks mtt-tabs-hidden">
                            <a href="#alltasks">
                                <span><?php echo lang('alltasks') ?></span>
                    ...
                    <h3>
                        <span id="taskview" class="mtt-menu-button">
                            <span class="btnstr"><?php echo lang('tasks') ?></span>
                            (<span id="total">0</span>) <span class="arrdown"></span></span>

                        <span class="mtt-notes-showhide">
                            <?php echo lang('notes') ?>
                            <a href="#" id="mtt-notes-show"><?php echo lang('notes_show') ?></a> / <a
                            href="#" id="mtt-notes-hide"><?php echo lang('notes_hide') ?></a></span>

                        <span id="mtt_filters"></span>
                        <span id="tagcloudbtn" class="mtt-menu-button">
                            <?php echo lang('tagcloud') ?>
                ...
                <div id="page_taskedit" style="display:none">
                    ...
                    <form id="taskedit_form" name="edittask" method="post" action="">
                        ...
                        <div class="form-row" id="alltags" style="display:none;"><?php echo lang('alltags') ?> <span
                ...
                <div id="listmenucontainer" class="mtt-menu-container" style="display:none">
                    <ul>
                        ...
                        <li class="mtt-need-list mtt-need-real-list"
                            id="btnClearCompleted"><?php echo lang('list_clearcompleted') ?></li>
                        ...
                        <li class="mtt-need-list sort-item" id="sortByDateCreated">
                            <div class="menu-icon"></div><?php echo lang('sortByDateCreated') ?> <span
                            class="mtt-sort-direction"></span></li>
                        <li class="mtt-need-list sort-item" id="sortByPrio">
                            <div class="menu-icon"></div><?php echo lang('sortByPriority') ?> <span class="mtt-sort-direction"></span>
                        </li>
                        <li class="mtt-need-list sort-item" id="sortByDueDate">
                            <div class="menu-icon"></div><?php echo lang('sortByDueDate') ?> <span class="mtt-sort-direction"></span>
                        </li>
                        <li class="mtt-need-list sort-item" id="sortByDateModified">
                            <div class="menu-icon"></div><?php echo lang('sortByDateModified') ?> <span
                            class="mtt-sort-direction"></span></li>
    ...
    <script type="text/javascript" src="<?php echo site_url('home/getJSData') ?>/?v=1.4.2"></script>
